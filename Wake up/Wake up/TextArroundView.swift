//
//  TextArroundView.swift
//  Wake up
//
//  Created by Muhammad Afif Maruf on 24/05/23.
//

import SwiftUI

struct TextArroundView: View {
    var radius: Double
    var text: String
...
struct TextArroundView_Previews: PreviewProvider {
    static var previews: some View {
        TextArroundView(radius: 180, text: "Hello World", kerning: 25)
    }
}
